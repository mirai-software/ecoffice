...
export function CreateReportModal() {
  ...
  const createReportRequest = api.admin.createReportRequest.useMutation();
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Il Report è stato aggiunto con successo",
      });
      setNewuuid(uuidv4());
      setAddress("");
      setType("");
          ...
          <Select value={type} onValueChange={(value) => setType(value)}>
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="RAEE-1">RAEE 1</SelectItem>
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] max-h-[90%] rounded-lg bg-white">
          <DialogHeader>
            <DialogTitle>Aggiungi Report </DialogTitle>
          </DialogHeader>
          {renderContent()}
        </DialogContent>
      </Dialog>
      ...
      <Drawer open={open} onOpenChange={setOpen}>
        ...
        <DrawerContent className="max-h-[90%] rounded-lg bg-white">
          <DrawerHeader className="text-left">
            <DrawerTitle>Aggiungi Report</DrawerTitle>
          </DrawerHeader>
          {renderContent()}
        </DrawerContent>
      </Drawer>
